...
//All abstracted
 double myBPM = pulseSensor.getBeatsPerMinute();  // Calls function on our pulseSensor object that returns BPM as an "int".
...
if (pulseSensor.sawStartOfBeat()) {            // Constantly test to see if "a beat happened". ]
 float sigmoidBPM = (1/(-0.75)) * log(60/myBPM); // derived in math
